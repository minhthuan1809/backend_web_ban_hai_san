...
<?php
// [PUT] http://localhost/backend_web_ban_hai_san/index1.php/api/client/v1/customer_section/customer_img_section/1 
//      {
//                "image_url": "...",
//                "title": "..."
//            }
...
try {
    ...
    if (empty($data) || !isset($data['image_url'])) {
        throw new Exception("Không có dữ liệu hình ảnh được gửi");
    }

    // Chuẩn bị câu lệnh SQL với id = 1
    $sql = "UPDATE layout_customer_section_img SET image_url = ? WHERE id = 1";
